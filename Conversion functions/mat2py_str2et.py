...
# The function cspice_str2et in MATLAB can receive 2 types of inputs for "timstr":
# [n,c1]=size(timstr); char = class(timstr)
# OR
# [1,n] =size(timstr); cell = class(timstr).
# We expect to receive a numpy.array of strings (shape : [n,1]) or a list of n strings.
